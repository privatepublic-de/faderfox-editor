let SPC4 = {
  ...
  title_send: 'Send data to PC4',
  msg_send:
    'Set your PC4 to system mode (press left+right button, yellow LED must be on).\
                Then press <i>Send</i> button below to start transfer. Red LED shows data transfer.',

  msg_apply: 'Received setup data from PC4. Apply to editor?',
  msg_data_applied: 'Setups from PC4 applied to editor!',
  $msg_invalid_data: 'Received invalid sysex data. {}',

  title_receive: 'Receive from PC4',
  msg_receive:
    'Send your current PC4 settings to this editor:\
  ...
  $msg_paste:
    'Paste clipboard content to current setup number {}? This will overwrite existing values.',
  ...
  msg_all_pots:
    'Enter a MIDI channel number to be applied to all pots in current setup.'
};
