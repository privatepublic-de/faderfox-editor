let STR = {
    ...
    midictrl: {
        nomidi: "Failed to get MIDI access. Please <a href='javascript:window.location.reload()'>try reloading this page</a> and confirm MIDI access when the browser is asking for it.",
        nooutputs: "No MIDI output devices present!",
        noinputs: "No MIDI input devices present!",
        nodevices: "No MIDI devices present!",
        nomidisupport: "Sorry, no MIDI support in this browser. So far, the only browsers supporting MIDI are Chrome and Open Source Chromium.\
            <br/><br/>You can still use this editor to edit, load and save Sysex files that can be\
            transfered to the device with a Sysex dump tool.\
        ",
        title_error: "MIDI Error",
        title_send: "Send data",
        msg_sending: "Sending data...",
